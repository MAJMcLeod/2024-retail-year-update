...
function animate() {
  tl.set(["#main_content", "#crewMember"], { autoAlpha: 1, rotation: 0.01, force3D: true });
  ...
  .to('#globeHolder', 0.75, { scale: 0.59, ease: 'none'}, 'frame2')
  ...
  .to('#nameTagMask', 0.4, { y: 4, ease: 'none'}, 'frame2+=2')
  .to('#nameTagMask', 0.1, { autoAlpha: 0, ease: 'none'})


  .addLabel('frame3', "frame2+=2")
  .to('#badgeHolder', 1.5, { scale: 0.06, y: '+=6', x: '+=13', ease: "none" }, 'frame3')
  .to('#crewMember', 1.5, { scale: 1, ease: 'none' }, 'frame3')
  .to('#blue-mask', 0.5, { autoAlpha: 0, ease: 'none' }, 'frame3')
